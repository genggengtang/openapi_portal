		...
		<div id="msform">
			...
			<fieldset>
				...
				<div class="form-group  has-feedback">
				  ...
				  <input type="text" class="form-control logins"  placeholder="请输入用户名"  name ="username">
				</div>
				<div class="form-group  has-feedback">
				  <span class="form-control-feedback gly" aria-hidden="true">
				  	<i class="glyphicon glyphicon-lock"></i>  <span >|</span>
				  </span>
				  <input type="password" name="password"  class="form-control logins"  placeholder="请输入密码"  name="password"/>
				</div>
				</div>
				<input type="submit" class="next action-button" value="下一步" />
				</form>
			</fieldset>
