/*
  ...
  var options={
    ...
    //调用
    方法1：$("#pager").Pager(options);
    方法2：var page1 = new Pager(null,options);
...
(function($,window,undefind){
    ...
    Pager.prototype = {
        ...
        selectPage : function(n){
            this._config['pno'] = n;
            this.pagerHtml(this._config,true);
        },
        //生成控件代码
        pagerHtml:function(config,enforceInit){
        ...
        focus_gopage :function (){
            ...
            $btnGo.css({
                    'left':'0px'
            }).show().animate({left: '+=80'}, 50,function(){
